    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Theme.of(context).primaryColor.withValues(alpha:.15), width: 1),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: CustomImageWidget(
                      ...
                      fit: BoxFit.cover,
                      height: boxConstraint.maxWidth * 0.95,
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                ProductCategoryNameWidget(product: productModel),
                if (productModel.categoryDisplayName != null)
