...
class CodePickerWidgetState extends State<CodePickerWidget> {
      ...
      internalWidget = InkWell(
        ...
        child: Padding(
          ...
          child: Flex(
            ...
            children: <Widget>[
              Padding(
                padding:  EdgeInsetsGeometry.directional(start: widget.fromCountryList?10.0:0),
                child: SizedBox(width: 25, child: Padding(
                  padding:  EdgeInsets.all(widget.fromCountryList?2.0:0),
                  child: Image.asset(widget.fromCountryList? Images.country : Images.callIcon, color: widget.isCallPrimary ? Theme.of(context).primaryColor : Theme.of(context).primaryColor,),
                )),
              ),
  ...
  void showCodePickerWidgetDialog() async {
    ...
    final dialogElements = elements
        .where((item) =>
            !favorites.any((favorite) => favorite.code == item.code))
        .toList();
