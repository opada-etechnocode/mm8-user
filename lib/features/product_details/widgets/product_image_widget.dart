...
class _ProductImageWidgetState extends State<ProductImageWidget> {
      ...
      builder: (context, productController, _) {
        return Column(
          ...
          children: [
            InkWell(
              onTap: () {
                if (productModel!.productImagesNull != true &&
                                ...
                                child: productModel!.imagesFullUrl != null &&
                                    ...
                                    ? PageView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          final isVisible =
                                              (productController.imageSliderIndex ?? 0) == index;
                              ...
                              Positioned(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: _indicators(context, productController),
                                    ),
                                    const Spacer(),
                                    if (productModel!.imagesFullUrl != null &&
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          '${(productController.imageSliderIndex ?? 0) + 1}/${productModel!.imagesFullUrl!.length}',
                                        ),
                                      ),
                                  ],
                                ),
            ...
            if (productModel!.imagesFullUrl != null && productModel!.imagesFullUrl!.isNotEmpty)
              Padding(
  ...
  List<Widget> _indicators(BuildContext context, ProductDetailsController productController) {
