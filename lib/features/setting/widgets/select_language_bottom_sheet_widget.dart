              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Padding(
                  ...
                  child: CustomButton(buttonText: '${getTranslated('select', context)}', onTap: (){
                    ...
                    Provider.of<BrandController>(context, listen: false).getBrandList(offset: 1, reload: true);
                    productController.getLatestProductList(1, reload: true);
                    productController.getFeaturedProductModel(1, isUpdate: true, reload: true);
                    Provider.of<FeaturedDealController>(context, listen: false).getFeaturedDealList(reload: true);
                    ...
                    productController.getRecommendedProduct(reload: true);
