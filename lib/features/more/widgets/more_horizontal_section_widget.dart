        ...
        final items = <Widget>[
          ...
          if (!isGuestMode)
            SquareButtonWidget(
              ...
              navigateTo: null,
              onTap: () => RouterHelper.getOrderScreenRoute(isBackButtonExist: true),
              count: 1,
              hasCount: false,
              isWallet: true,
              subTitle: 'orders',
          ...
          Consumer<WishListController>(
            builder: (context, wishListController, _) {
              return SquareButtonWidget(
                ...
                navigateTo: null,
                onTap: () => RouterHelper.getWishListRoute(action: RouteAction.push),
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: ResponsiveHelper.isTab(context) ? 104 : 96,
