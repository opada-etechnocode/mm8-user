...
class DashBoardScreenState extends State<DashBoardScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _screens = [
        ...
        NavigationModel(name: 'CATEGORY', icon: Images.category, screen: CategoryScreen(fromDashboard: true)),
  ...
  void _loadSecondaryDashboardData() {
    final splashController = Provider.of<SplashController>(context, listen: false);
    final searchController = Provider.of<SearchProductController>(context, listen: false);

    if (splashController.defaultBusinessPages == null) {
      splashController.getBusinessPagesList('default');
    }
    if (splashController.businessPages == null) {
      splashController.getBusinessPagesList('pages');
    }

    searchController.getAuthorList(null);
    searchController.getPublishingHouseList(null);
