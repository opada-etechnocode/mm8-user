...
class FashionThemeHomePage extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload) async {
    ...
    await HomeLoadHelper.runGuarded(
      ...
      secondaryTasks: [
        () async => shopController.getAllSellerList(offset: 1, isUpdate: reload),
        () async => shopController.getTopSellerList(offset: 1, isUpdate: reload),
        () async => productController.getHomeCategoryProductList(reload),
        () async => brandController.getBrandList(offset: 1, isUpdate: reload, reload: reload),
        () async => productController.getLatestProductList(1, isUpdate: reload, reload: reload),
        () async => productController.getSelectedProductModel(1, isUpdate: reload, reload: reload),
        () async => productController.getFeaturedProductModel(1, isUpdate: reload, reload: reload),
        ...
        () async => productController.getMostDemandedProduct(),
        () async => productController.getMostSearchingProduct(1, isUpdate: reload),
        () async => shopController.getMoreStore(),
        () async => productController.getClearanceAllProductList(1, isUpdate: reload, reload: reload),
      ],
      deferredTasks: [
        () async {
