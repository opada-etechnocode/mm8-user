                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start, children: [
                          Expanded(
                            child: Row(
                              children: [
                                CustomAssetImageWidget(Images.deliveryTo, height: 20, width: 20,color: Theme.of(context).primaryColor,),
                                Padding(
                          ...
                          SizedBox(width: 20, child: Image.asset(Images.edit,
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                CustomAssetImageWidget(Images.savedAddressLocationIcon, height: 20, width: 20,color:Theme.of(context).primaryColor),
                    ...
                    child: Column(crossAxisAlignment:CrossAxisAlignment.start, children: [
                      ...
                      Padding(
                        ...
                        child: Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.center, children: [
                          Expanded(
                            child: InkWell(
                              onTap: !shippingProvider.sameAsBilling
                                  ? () => RouterHelper.getSavedBillingAddressListRoute(fromGuest: isGuestMode)
                                  : null,
                              child: Row(
                                children: [
                                  CustomAssetImageWidget(Images.billingTo, height: 20, width: 20,color:Theme.of(context).primaryColor),
                                  Expanded(
                                    child: Padding(
                                      padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                                      child: Text(
